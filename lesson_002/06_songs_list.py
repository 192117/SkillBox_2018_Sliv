...
for i in violator_songs_list:
    if i[0] == 'Halo' or i[0] == 'Enjoy the Silence' or i[0] == 'Clean':
        sum_time = i[1]
print('Three songs have', sum_time, 'min')
...
whole_time = round((violator_songs_dict['Sweetest Perfection'] + violator_songs_dict['Policy of Truth'] +\
             violator_songs_dict['Blue Dress']), 2)
print('Three another songs have', whole_time, 'min')