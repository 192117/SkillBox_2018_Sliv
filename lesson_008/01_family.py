...
class People:
    ...
    def eat(self):
        count = randint(1, 30)
        cprint('{} поел {}'.format(self.name, count), color='yellow')
...
class House:
    ...
    def __str__(self):
        return 'денег - {}, еды - {}, грязи - {}.'.format(self.money, self.food, self.dirt)

class Husband(People):

    def work(self):
        cprint('{} работаю'.format(self.name), color='red')
        self.fullness -= 10
        self.house.money += 150

    def gaming(self):
        cprint('{} играю в WoT'.format(self.name), color='red')
        self.fullness -= 10
        self.happiness += 20
...
class Wife(People):
    ...
    def shopping(self):
        cprint('{} покупаю еды'.format(self.name), color='red')
        self.fullness -= 10
        quantity = randint(10, 40)
        self.house.food += quantity
    ...
    def clean_house(self):
        cprint('{} убираю этот срач'.format(self.name), color='red')
        self.fullness -= 10
        self.house.dirt -= 100
